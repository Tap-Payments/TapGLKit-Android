...
public class Shader {
    ...
    public static String QuadGradientViewFragmentShader = "uniform highp vec2 resolution;" +
    ...
    public  static String TapActivityIndicatorViewFragmentShader = "#define M_PI 3.1415926535897932384626433832795" +
            "#define YES 1" +
            "" +
